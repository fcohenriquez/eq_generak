...
```{r}
model@residual_vector[c(19)] # Residuo de la funcion de utilidad
var_info(model,variables=c('U', 'lambda__CONSUMER_1')) 
```
[1] 0.0361397 con omega=1.1 y alfa=0.2 y U=1
[1] -0.1892402 con omega=1.1 y alfa=0.2 sin U ni lambda
[1] -0.2169825 con omega=1.1 y alfa=0.2 y U=0.5 y lambda=0.8
...
```
[1] -0.013180964 -0.034711270 -0.008319843 con param excel


```{r}
round(model@residual_vector[c(68, 72, 65, 62, 39)], digits=4 )
list_eq(model, eq_idx = c(68, 72, 65, 62, 39))

round(model@residual_vector[c(29, 55, 58, 59, 68)], digits=4 )
list_eq(model, eq_idx = c(29, 55, 58, 59, 68)) #la 58 es el cierre del mercado de capital
```
```{r}
